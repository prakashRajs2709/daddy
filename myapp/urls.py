...
urlpatterns = [
    ...
    path('edit2/<int:pk>/', views.edit_record2, name='edit_record2'),
    ...
    path('edit3/<int:pk>/', views.edit_record3, name='edit_record3'),
    ...
    path('edit4/<int:pk>/', views.edit_record4, name='edit_record4'),
